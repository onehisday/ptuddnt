...
const String HOUZI_VERSION = "1.2.0";
...
const String MIN_PRICE = "0";
const String MAX_PRICE = "5000000";
const String MIN_AREA = "0";
const String MAX_AREA = "1000000";
...
/// Show Property detail bottom bar options
...
const String HOUZI_URL_PLUG_IN = "https://github.com/booleanbites/houzi-rest-api/releases/latest.zip";
...
/// Term Picker Types
const String dropDownTermPicker = "dropdown";
...
const String SEARCH_RESULTS_FEATURES = "feature[]";
...
const String homeScreenWidgetsListingCarouselView = "carousel";
const String homeScreenWidgetsListingListView = "list";
const String homeScreenWidgetsListingSliderView = "slider";
...
const String kDealDeleteNonceName = "delete_deal_nonce";
const String kDealDeleteNonceVariable = "security";

const String kLeadDeleteNonceName = "delete_lead_nonce";
const String kLeadDeleteNonceVariable = "security";

const String kAddNoteNonceName = "note_add_nonce";
