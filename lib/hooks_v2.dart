...
import 'package:houzi_package/interfaces/hooks_v2_interface.dart';
...
class HooksV2 implements HooksV2Interface{
  ...
  Map<String, dynamic> getHeaderMap() {
    Map<String, dynamic> map = {
      "app-secret": "cuongkhoaluan",
      // "secret_key": "994b26c4-fe7c-40c3-ad88-f6a8a08d33e0",
    };
    return map;
  }
  ...
  LanguageHook getLanguageCodeAndName() {
    LanguageHook languageHook = () {
      ...
      Map<String,dynamic> vietnamLanguageMap = {
        "languageName": "Việt Nam", // Specify your language name
        "languageCode": "vi"  // Specify your language code
      };
